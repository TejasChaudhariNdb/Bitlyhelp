...
$sql = "SELECT * FROM url_shorten where user_id = 1";
...
<span><a class="text-sm bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Edit  </a> <a class="text-sm ml-3 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Hide</a></span>
