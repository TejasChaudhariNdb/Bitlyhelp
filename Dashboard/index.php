...
<div class="grid md:grid-cols-4 grid-cols-2   gap-4">
  <div class="bg-purple-700 text-white  p-4"><p class="text-4xl">$80</p><p>Total views</p></div>
  
  <div class="bg-yellow-400 p-4"><p class="text-4xl">$80</p><p>Total Earnings</p></div>
  <div class="bg-red-600 text-white  p-4"><p class="text-4xl">$80</p><p>Referral Earnings</p></div>
  <div class="bg-gray-900 text-white p-4"><p class="text-4xl">$80</p><p>Average CMP</p></div>
